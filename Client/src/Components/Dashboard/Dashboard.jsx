  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setDashboardData({
          stats: Array.isArray(data.data?.stats) ? data.data.stats : [],
          recentWorkouts: Array.isArray(data.data?.recentWorkouts) ? data.data.recentWorkouts : [],
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {Array.isArray(dashboardData.stats) && dashboardData.stats.map((stat, index) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="space-y-4">
              {Array.isArray(dashboardData.recentWorkouts) && dashboardData.recentWorkouts.map((workout, index) => (
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="space-y-5">
              {Array.isArray(dashboardData.goals) && dashboardData.goals.map((goal, index) => (
                <div key={index}>
